#include "recite.h"
//听写单词
void goToRecite(GtkEntry *user_entry, gpointer data) {
    //用于创建二级页面的回调函数
    recite_secondary_window(user_entry, data);
}

void recite_secondary_window(GtkEntry *user_entry, gpointer data) {
    ...
    gtk_window_set_title(GTK_WINDOW(secondary_window), "背诵单词");
